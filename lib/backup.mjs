...
import { validUiSettings } from '../public/ui-settings.js';
...
function cleanBackup(value) {
  ...
  if (!validDisplaySettings(value.data.displaySettings) || !appSettings || !validUiSettings(value.data.uiSettings)) {
  ...
  return {
    ...
    data: {
      ...
      appSettings,
      uiSettings: structuredClone(value.data.uiSettings),
      profile,
    },
  };
}
